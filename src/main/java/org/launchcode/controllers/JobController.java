...
public class JobController {
    ...
    public String add(Model model, @Valid JobForm jobForm, Errors errors) {
        ...
        model.addAttribute("employerId", anEmployer);
        model.addAttribute("locationId", aLocation);
        model.addAttribute("coreCompetencyId", aCoreCompetency);
        model.addAttribute("positionType", aPositionType);
